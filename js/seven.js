...
$(function () {
    ...
    $(".liangdian_img").click(
        function () {
            ...
            $(this).children(".liangdian_img_hide").slideToggle();
        }
    );
    $(".liangdian_img").hover(
        function () {
            $(this).css("border-bottom","3px solid #cc0000");
            $(this).children(".ov").children("img").stop().animate({"margin-left":"-87px"},300);
        },
        function () {
            $(this).css("border-bottom","3px solid #3e4146");
            $(this).children(".ov").children("img").stop().animate({"margin-left":"-97px"},300);
        }
    )
